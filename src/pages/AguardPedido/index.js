...
export default class AguardPedido extends Component{
  constructor(props){
    super(props);
    this.state = {
      imgMotoboy: require('../../assets/moto.png'),
      imgCarroComum: require('../../assets/carroComum.png'),
      imgCarroUtilitario: require('../../assets/carroUtilitario.png'),
      ...
      mostrar: true,
      tipoVeiculo: this.props.selecaoVeiculo,
  ...
  animacao(){
    ...
    imgVeiculo(){
      switch(this.state.tipoVeiculo){
        case 1:
          return this.state.imgCarroComum;
        case 2:
          return this.state.imgCarroUtilitario;
        case 3:
          return this.state.imgMotoboy;
      }
    }
  render(){
    return(
